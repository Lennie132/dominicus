...
<div class="container" lcms-grid="12">Contact
    <div class="row">rij
        <div class="col-md-12" id="content" default="true">Content</div>
    </div>
    <div class="row">rij
        <div class="col-md-6" id="google-maps" default="true">Google Maps</div>
        <div class="col-md-6" id="contact" default="true">Contact</div>
    </div>
</div>
