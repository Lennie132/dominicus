...
<div class="groep-8-top-row">
  <div class="row">
    <div class="col-lg-4 col-md-6 block block-wrapper top-left-block">
    ...
    <div class="col-lg-4 col-md-12 col-sm-12 block-wrapper">
      ...
      <div class="row">
        <div class="block-kom-kijken-groep8 col-lg-12 col-md-6">
        ...
        <div class="block-projecten col-lg-12 col-md-6">
  <!--    <img class="icon-kom-kijken" src="<?= lcms::resize('img/icon-kom-kijken.png', 65, 65, '', 80); ?>">-->
          <?php echo lcms::Template()->getSectieContent($DATA['page'], 'projecten'); ?>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-12 block-wrapper">
      <div class="block block-filmmakers">
        ...
        <img class="icon-filmmakers-groep8" src="<?= lcms::resize('img/icon-filmmakers.png', 50, 50, '', 80); ?>">
      </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-12 block-wrapper">
