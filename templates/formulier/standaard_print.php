...
<div class="<?= $form->config('klasse'); ?>" id="anchor_<?= $form->config('block_id') ?>">
  ...
  <form action="<?php echo $form->getAction(); ?>#anchor_<?= $form->config('block_id'); ?>" id="form-print" enctype="multipart/form-data" method="post" class="<?= $form->config('form_klasse') ?>">
					<?php
					$hidden = '';
					...
					if ($form->getBetaalstatus() == 'verify') {
						...
						?>
						<div class="formulier_div_submit" id="form_div_submit_<?= $form->config('block_id'); ?>">
                                <button class="form_submit btn" id="submit-print" ><?= $form->config('knop_value'); ?></button>
								<input class="form_submit btn" id="submit-form" type="submit" name="submit_form[<?= $form->config('block_id'); ?>]" value="<?= $form->config('knop_value') ?>"/>
						</div>
<?php			} ?>
			</form>
<?php } ?>
